...
/**
 * Servlet implementation class SelectFileByUsernameServlet
 */
@WebServlet("/SelectFileByUsernameServlet")
public class SelectFileByUsernameServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SelectFileByUsernameServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<FileMsg> list = dao.selectByName(user.getUsername());
